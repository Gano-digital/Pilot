...
3. **Imágenes**: cada bloque con icono o ilustración debe tener `alt` descriptivo en español.
4. **Coming soon / borradores**: cualquier página no lista debe quedar en borrador para no competir SEO con la home.
