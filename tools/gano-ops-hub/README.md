...
| `../../scripts/generate_gano_ops_progress.py` | Fuente de verdad: parsea checkboxes en `TASKS.md` y `dispatch-queue.json` |
...
2. Sube `public/` como artefacto de Pages y despliega.
