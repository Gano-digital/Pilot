...
<main class="gano-home" id="gano-home-main" data-gano-homepage>
    <section class="hero-gano gano-hero-overlay">
        <div class="gano-shell hero-content">
            ...
            <div class="hero-cta-row">
                ...
                ?>
                <a href="<?php echo esc_url( $url_shop ); ?>" class="btn-gano btn-gano--secondary"><?php esc_html_e( 'Explorar catálogo inteligente', 'gano-child' ); ?></a>
            </div>
    ...
    <div class="gano-trust-bar" role="complementary" aria-label="<?php esc_attr_e( 'Señales de confianza', 'gano-child' ); ?>">
        <div class="gano-trust-bar__inner">
            <span class="gano-trust-item">
                ...
                <?php esc_html_e( 'Reseller oficial GoDaddy', 'gano-child' ); ?>
            </span>
            <span class="gano-trust-item">
                ...
                <?php esc_html_e( 'SLA objetivo ≥ 99,9% uptime', 'gano-child' ); ?>
            </span>
            <span class="gano-trust-item">
                ...
                <?php esc_html_e( 'Soporte en español', 'gano-child' ); ?>
            </span>
            <span class="gano-trust-item">
                ...
                <?php esc_html_e( 'NVMe Gen4 real', 'gano-child' ); ?>
            </span>
            <span class="gano-trust-item">
                ...
                <?php esc_html_e( 'Facturación en COP', 'gano-child' ); ?>
            </span>
        </div>
    </div>
