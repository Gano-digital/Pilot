 ...
 *
 * Funcionalidades:
 *   1. Schema JSON-LD: Organization, LocalBusiness, WebSite (todas las páginas)
 ...
 *       por defecto (LocalBusiness, BreadcrumbList personalizado, FAQ custom).
 */
...
function gano_seo_config(): array {
    return array(
        ...
        'address_street'  => get_option( 'gano_seo_street',       'Bogotá, Colombia' ),
        'address_city'    => get_option( 'gano_seo_city',         'Bogotá' ),
        'address_region'  => get_option( 'gano_seo_region',       'Cundinamarca' ),
        'address_country' => 'CO',
        'address_postal'  => get_option( 'gano_seo_postal',       '' ),
        'latitude'        => get_option( 'gano_seo_lat',          '4.6097' ),  // Bogotá default
        'longitude'       => get_option( 'gano_seo_lng',          '-74.0817' ),
...
function gano_output_base_schema(): void {
    // Si Rank Math ya genera Organization+LocalBusiness, solo agregar WebSite y datos faltantes.
...
function gano_seo_settings_page(): void {
    ...
    if ( isset( $_POST['submit'] ) ) {
        ...
        $fields = array(
            'gano_seo_legal_name', 'gano_seo_nit', 'gano_seo_phone', 'gano_seo_whatsapp',
    ...
    <div class="wrap">
        ...
        <p>Estos datos se usan en el Schema JSON-LD (Google, Bing) y en las etiquetas Open Graph. Rellénalos con información real para maximizar el SEO local en Colombia.</p>
        <form method="post">
            ...
            <table class="form-table" role="presentation">
                ...
                $fields_labels = array(
                    ...
                    'gano_seo_street'     => array( 'Dirección',        'Calle 184 #18-22',         'address_street' ),
                    'gano_seo_city'       => array( 'Ciudad',           'Bogotá',                   'address_city' ),
                    'gano_seo_region'     => array( 'Departamento',     'Cundinamarca',             'address_region' ),
                    'gano_seo_postal'     => array( 'Código postal',    '110111',                   'address_postal' ),
